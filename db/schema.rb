...
ActiveRecord::Schema.define(version: 20_151_225_123_843) do
  ...
  add_index 'accounts', %w(user_id name), name: 'by_user_name', unique: true, using: :btree
  ...
  add_index 'budgets', %w(category_id budget_month), name: 'by_category_month', unique: true, using: :btree
  ...
  add_index 'categories', %w(user_id name), name: 'by_user_name', unique: true, using: :btree
  ...
  add_index 'debt_balances', %w(debt_id due_date), name: 'by_debt_due_date', unique: true, using: :btree
  ...
  add_index 'debts', %w(name deleted_at), name: 'by_category_name', unique: true, using: :btree
  ...
  add_index 'payment_methods', %w(user_id name), name: 'by_user_name', unique: true, using: :btree
  ...
  add_index 'user_contributors', %w(contributor_user_id user_id), name: 'index_user_contributors_on_contributor_user_id_and_user_id', unique: true, using: :btree
  add_index 'user_contributors', %w(user_id contributor_user_id), name: 'index_user_contributors_on_user_id_and_contributor_user_id', unique: true, using: :btree
