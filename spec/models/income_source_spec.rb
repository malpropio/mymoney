...
RSpec.describe IncomeSource, type: :model do
  ...
  context "returns the right number of paychecks" do
    ...
    it "for total of multiple sources" do
      income_source = FactoryGirl.create(:income_source, start_date: "2014-01-03", end_date: "2017-01-06", pay_day: "friday", pay_schedule: "weekly")
      income_source = FactoryGirl.create(:income_source, start_date: "2014-01-03", end_date: "2017-01-06", pay_day: "friday", pay_schedule: "bi-weekly")
      income_source = FactoryGirl.create(:income_source, pay_day: "16,first", pay_schedule: "semi-monthly", start_date: "2014-01-03", end_date: "2017-01-06")
    ...
    it "for total of multiple sources per account" do
      ...
      income_source = FactoryGirl.create(:income_source, account: account, start_date: "2014-01-03", end_date: "2017-01-06", pay_day: "friday", pay_schedule: "weekly")
      income_source = FactoryGirl.create(:income_source, account: account, start_date: "2014-01-03", end_date: "2017-01-06", pay_day: "friday", pay_schedule: "bi-weekly")
      income_source = FactoryGirl.create(:income_source, pay_day: "16,first", pay_schedule: "semi-monthly", start_date: "2014-01-03", end_date: "2017-01-06")
  ...
  context "returns the right income amount" do
    it "for weekly" do
      income_source = FactoryGirl.build(:income_source, start_date: "2014-01-03", end_date: "2017-01-06", pay_day: "friday", pay_schedule: "weekly")
      expect(income_source.income(Date.new(2013,1,1),Date.new(2018,1,1))).to eq(158000)
      expect(income_source.income(Date.new(2015,1,1),Date.new(2016,1,1))).to eq(53000)
    end

    it "for bi-weekly" do
      income_source = FactoryGirl.build(:income_source, start_date: "2014-01-03", end_date: "2017-01-06", pay_day: "friday", pay_schedule: "bi-weekly")
      expect(income_source.income(Date.new(2013,1,1),Date.new(2018,1,1))).to eq(79000)
      expect(income_source.income(Date.new(2015,1,1),Date.new(2016,1,1))).to eq(27000)
    end

    it "for semi-monthly" do
      income_source = FactoryGirl.build(:income_source, pay_day: "16,first", pay_schedule: "semi-monthly", start_date: "2014-01-03", end_date: "2017-01-06")
      expect(income_source.income(Date.new(2013,1,1),Date.new(2018,1,1))).to eq(72000)
      expect(income_source.income(Date.new(2015,1,1),Date.new(2016,1,1))).to eq(25000)
    end
    ...
    it "for total of multiple sources" do
      ...
      income_source = FactoryGirl.create(:income_source, start_date: "2014-01-03", end_date: "2017-01-06", pay_day: "friday", pay_schedule: "bi-weekly")
      income_source = FactoryGirl.create(:income_source, pay_day: "16,first", pay_schedule: "semi-monthly", start_date: "2014-01-03", end_date: "2017-01-06")
      expect(IncomeSource.total_income(nil, Date.new(2013,1,1),Date.new(2018,1,1))).to eq(309000)
      expect(IncomeSource.total_income(nil, Date.new(2015,1,1),Date.new(2016,1,1))).to eq(105000)
    end
    ...
    it "for total of multiple sources per account" do
      ...
      income_source = FactoryGirl.create(:income_source, account: account, start_date: "2014-01-03", end_date: "2017-01-06", pay_day: "friday", pay_schedule: "bi-weekly")
      income_source = FactoryGirl.create(:income_source, pay_day: "16,first", pay_schedule: "semi-monthly", start_date: "2014-01-03", end_date: "2017-01-06")
      expect(IncomeSource.total_income(account, Date.new(2013,1,1),Date.new(2018,1,1))).to eq(237000)
      expect(IncomeSource.total_income(account, Date.new(2015,1,1),Date.new(2016,1,1))).to eq(80000)
    end
  end
end
