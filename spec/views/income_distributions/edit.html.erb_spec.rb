...
RSpec.describe "income_distributions/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit income_distribution form" do
    render

    assert_select "form[action=?][method=?]", income_distribution_path(@income_distribution), "post" do
